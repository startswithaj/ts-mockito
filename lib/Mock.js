...
var Mocker = (function () {
    function Mocker(clazz, instance, options) {
        if (instance === void 0) { instance = {}; }
        if (options === void 0) { options = { throwIfMockedFunctionIsNotStubbed: false }; }
        var _this = this;
        this.clazz = clazz;
        ...
        if (typeof Proxy !== "undefined" && this.clazz) {
            ...
            this.instance = new Proxy(this.instance, {
                get: function (target, name) {
                    ...
                    if (!hasMethodStub) {
                        var isInstanceAndFunctionCall = true;
                        return _this.createActionListener(name.toString(), isInstanceAndFunctionCall);
                    }
                    return target[name];
                },
            });
    ...
    Mocker.prototype.createActionListener = function (key, isInstanceAndFunctionCall) {
        var _this = this;
        return function () {
            var args = [];
            ...
            var methodStub = _this.getMethodStub(key, args, isInstanceAndFunctionCall);
    ...
    Mocker.prototype.getMethodStub = function (key, args, isInstanceAndFunctionCall) {
